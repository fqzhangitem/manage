        ...
        <el-card class="box-card">
            ...
            >
                ...
                <template slot="lev" slot-scope="scope">
                    <el-tag v-if="scope.row.lev===1">一级类别</el-tag>
                    <el-tag type="success" v-else-if="scope.row.lev===2">二级类别</el-tag>
                    <el-tag type="danger" v-else>三级类别</el-tag>
                </template>
                <!-- 操作 -->
            ...
            ></el-pagination>
            <!-- 添加弹出框 -->
            <el-dialog title="添加类别" :visible.sync="addDialogVisible" @close="addCloseDialog" width="50%">
        <span>
          ...
          <el-button type="primary" @click="add" :disabled="btnDisabled" :loading="btnLoading">确 定</el-button>
            ...
            <!-- 编辑弹出框 -->
            <el-dialog title="编辑类别" :visible.sync="editDialogVisible" @close="editCloseDialog" width="50%">
        <span>
        ...
        methods: {
                ...
                this.$refs.editRuleFormRef.validate(async valid => {
                    if (!valid) {
                        ...
                        if (res.success) {
                            ...
                            this.$message.error("类别信息更新失败:" + res.data.errorMsg);
                        }
            ...
            async edit(id) {
                ...
                if (res.success) {
                    ...
                    return this.$message.error("类别信息编辑失败"+res.data.errorMsg);
                }
            ...
            async getCategoryList() {
                ...
                if (!res.success) return this.$message.error("类别列表失败");
            ...
            async getParentCategoryList() {
                ...
                if (!res.success) return this.$message.error("父级类别列表失败:"+res.data.errorMsg);
                ...
                this.$refs.addRuleFormRef.validate(async valid => {
                    if (!valid) {
                        ...
                        if (res.success) {
                            ...
                            return this.$message.error("类别添加失败:" + res.data.errorMsg);
                        }
